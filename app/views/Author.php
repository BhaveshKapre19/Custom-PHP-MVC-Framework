...
<div class="container">
	<!--			<div class="row">-->
	<h2 class="mt-5 display-4 text-center rndmBgClr"><?php echo $data['title']; ?></h2>

	<?php if (empty($data['AuthPostData'])) {
	 	echo "<script>alert('This Author Has Not Posted Anything');</script>";
	 } ?>

	<?php //print_r($data['AuthPostData']); ?>
	<!-- code of php goes here -->
	<?php foreach ($data['AuthPostData'] as $post): ?>
	
	<div class="col-md-9 mt-5 mb-1 p-3 border">
