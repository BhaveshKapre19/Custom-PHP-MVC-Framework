...
<div class="row">
	<div class="col-md-8 text-center" style="margin-left: 290px;">
		...
		<img src="<?php echo POSTIMAGE .$data['post_image']; ?>" alt="postHeader" id="ImgPrev" class="img-fluid" width="300" height="400">
		<div class="p-4 m-3">
			<form action="" method="post" class="text-center" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<textarea name="post_content" id="postContent" cols="30" rows="10" class="<?php echo (!empty($data['post_content_error'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['post_content']; ?>">
...
// 		$categorie = $_POST['post_categorie'];
// 		$userID = $_SESSION['user_id'];

// 		$qq = "INSERT INTO post(post_title,post_categorie,post_author) VALUES ('$title',$categorie,$user)";
