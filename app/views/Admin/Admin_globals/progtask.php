           ...
           <div class="row mb-4 align-items-center">
             <div class="col-xl-6 col-12 mb-4 mb-xl-0">
               <div class="bg-dark text-white p-4 rounded">
                 ...
                 <h6 class="mb-3">Mozilla Fire-fox</h6>
                 <div class="progress mb-4" style="height: 20px">
                 ...
                 <div class="progress mb-4" style="height: 20px">
                    <div class="progress-bar progress-bar-striped font-weight-bold bg-danger" style="width: 61%">
                      61%
                    </div>
                 </div>
                 <h6 class="mb-3">IE</h6>
             ...
             <div class="col-xl-6 col-12">
               ...
               <div class="container-fluid bg-white">
                 <div class="row py-3 mb-4 task-border align-items-center">
                   ...
                   <div class="col-1">
                     <a href="#" data-toggle="tooltip" title="<h6>edit</h6>" data-html="true"><i class="fas fa-edit fa-lg text-success mr-2"></i></a>
                   </div>
                   <div class="col-1">
                     <a href="#" data-toggle="tooltip" title="<h6>delete</h6>" data-html="true"><i class="fas fa-trash-alt fa-lg text-danger"></i></a>
                   </div>
                 </div>
               </div>
